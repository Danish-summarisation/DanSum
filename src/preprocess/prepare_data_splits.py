...
# %% LOAD DATA
ds_clean = load_dataset("csv", data_files="tok_ds_clean.csv")
...
train_clean1.to_csv("train_clean1.csv")
test_clean1.to_csv("test_clean1.csv")
val_clean1.to_csv("val_clean1.csv")
