...
# %% LOAD DATA
ds_clean = load_dataset("csv", data_files="/data/danish_summarization_danewsroom/tok_ds_clean.csv")
...
df25k_clean.to_csv("/data/danish_summarization_danewsroom/clean25k.csv")  # save csv
...
train25k_clean.to_csv("/data/danish_summarization_danewsroom/train25k_clean.csv")
test25k_clean.to_csv("/data/danish_summarization_danewsroom/test25k_clean.csv")
val25k_clean.to_csv("/data/danish_summarization_danewsroom/val25k_clean.csv")
...
train_clean1.to_csv("/data/danish_summarization_danewsroom/train_clean1.csv")
test_clean1.to_csv("/data/danish_summarization_danewsroom/test_clean1.csv")
val_clean1.to_csv("/data/danish_summarization_danewsroom/val_clean1.csv")
