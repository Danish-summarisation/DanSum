...
train25k_clean, test25k_clean = ds25k_clean.train_test_split(test_size=test_len).values() # absolute size specified
train25k_clean, val25k_clean = train25k_clean.train_test_split(test_size=val_len).values()
